...
<head>
    ...
    <script src="${basepath}/static/blog/js/jquery-1.8.0.min.js" type="text/javascript"></script>
    <!--[if lt IE 9]>
    <script src="${basepath}/static/blog/js/modernizr.custom.js"></script>
    <![endif]-->
    <script src="${basepath}/static/blog/js/jquery.flexslider-min.js" type="text/javascript"></script>
    <script src="${basepath}/static/blog/js/functions.js" type="text/javascript"></script>
</head>
<body>
<div id="wrapper">
            ...
            <div class="header-inner">
                ...
                <div class="slider-holder">
                    <div class="flexslider">
                        <ul class="slides">
                            <li><img src="${basepath}/static/blog/img/slide-img.png" alt="" /></li>
        ...
        <div class="shell">
            <div class="container">
                ...
                <section class="blog">
                    <!-- content -->
                    <div class="content">
                        <img src="${basepath}/static/blog/img/i-img.png" alt=""  class="alignleft"/>
                        <div class="cnt">
                            ...
                            <ul>
                                <li>
                                    <div class="img-holder">
                                        <a href="#"><img src="${basepath}/static/blog/img/post-img.png" alt="" /></a>
                                    </div>
                                ...
                                <li>
                                    <div class="img-holder">
                                        <a href="#"><img src="${basepath}/static/blog/img/post-img2.png" alt="" /></a>
                                    </div>
                                ...
                                <li>
                                    <div class="img-holder">
                                        <a href="#"><img src="${basepath}/static/blog/img/post-img3.png" alt="" /></a>
                                    </div>
                                    <p>
                ...
                <section class="cols">
                    <div class="col">
                        ...
                        <img src="${basepath}/static/blog/img/cols-img.png" alt="" class="alignleft"/>
                        <div class="col-cnt">
                    ...
                    <div class="col">
                        <h3>We’re Hiring</h3>
                        <img src="${basepath}/static/blog/img/cols-img2.png" alt="" class="alignleft"/>
                        <div class="col-cnt">
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras molestie condimentum conse am leo libero, samet dor.</p>
                        </div>
                        <a href="#" class="view">View More</a>
                    ...
                    <div class="col">
                        <h3>Our Partners</h3>
                        <img src="${basepath}/static/blog/img/cols-img3.png" alt="" class="alignleft"/>
                        <div class="col-cnt">
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras molestie condimentum conse am leo libero, samet dor.</p>
                        </div>
                        <a href="#" class="view">View More</a>
